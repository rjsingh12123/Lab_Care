...
$a=$link->rawQuery("SELECT d.*,t.*,u.*,u1.*,v.* FROM diseasecategorytb d,TestTB t,UserReportTB u,UserTB u1,VendorTB v where u.TestID=t.TestID and u.DiseaseID=d.DiseaseID and u.UserID=u1.UserID and u.VendorID=v.VendorID ");
/*
if(isset($_GET['id']))
{
                    ...
                    <table id="order-listing" class="table">
                      <thead>
                        <tr align="center">
							...
							<th>From Collection Time</th>
							<th>To Collection Time</th>
							<th>IsPaid</th>
                        </tr>
                      </thead>
                      <tbody>
