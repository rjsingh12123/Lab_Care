...
$a=$link->rawQuery("SELECT p.*,u1.*,v.*,up.*,pr.UserReportPackageID,pr.IsUpload FROM PackageTB p,UserTB u1,userreortpackagetb up,packagereport pr,VendorTB v where pr.UserReportPackageID=up.UserReortPackage and up.PackageID=p.PackageID and up.UserID=u1.UserID and up.VendorID=v.VendorID and up.VendorID=".$_SESSION['vid']);
if(isset($_GET['ids']))
{
                    ...
                    <table id="order-listing" class="table">
					  ...
					  ?>
                        <tr align="center">
							...
							<!--<td><a href="<?php echo $b["Reading"];?>">Link</a></td> -->
							<td><a href="../../User_Report/Packagedemo.php?id=<?php echo $b["UserReortPackage"];?>">Link</a></td>
							...
							<td><a href="UserPackageReportDisplay.php?ids1=<?php echo $b["UserReortPackage"];?>"><?php echo $b["HomeCollection"];?></a></td>
							<td><?php echo $b["Status"];?></td>
							<td><a href="UserPackageReportDisplay.php?ids=<?php echo $b["UserReortPackage"];?>"><?php echo $b["Approve"];?></a></td>
							<td><a href="UserReportAdd.php?id8=<?php echo $b["UserReortPackage"];?>"><?php if($b["IsUpload"]==0) { ?><h3><i class="mdi mdi-border-color" style="color:blue;"></h3></i><?php } else { ?> <a href="<?php echo $b["Report"]; ?>">View</a></td><?php } ?></a></td>
					  <?php } ?>  
                        </tr>
                      </tbody>
                    </table>
