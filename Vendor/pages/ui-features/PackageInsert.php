...
include '../../connect.php'; 
   ...
   {
	   $n=$_POST['ciname'];
       $q=$link->insert('PackageTB',Array('Package_Name'=>$n));
   }
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- Mirrored from www.urbanui.com/appular/template/demo/vertical-default-light/pages/forms/basic_elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Feb 2019 04:07:24 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php 
					...
					{
				        $w=$_GET['id'];
	                    $p=$link->rawQueryOne("Select * from PackageTB where PackageID=".$w);
				  ?>
                  <form class="forms-sample1" action="Update.php?id=<?php echo $w;?>" method="post">
				    <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Package Name</label>
                          <div class="col-sm-9">
                            <input type="text" name="ciname" class="form-control" value="<?php echo $p["Package_Name"];?>" required>
                          </div>
                        </div>
                    </div>
					...
					{
						?>
						<form class="forms-sample1" action="PackageInsert.php" method="post">
				    <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Package Name</label>
                          <div class="col-sm-9">
                            <input type="text" name="ciname" class="form-control" required>
                          </div>
                        </div>
                    </div>
...
<!-- Mirrored from www.urbanui.com/appular/template/demo/vertical-default-light/pages/forms/basic_elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Feb 2019 04:07:28 GMT -->
</html>
