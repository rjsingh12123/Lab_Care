...
$a=$link->rawQuery("SELECT pc.*,p.Package_Name FROM PackageCategoryTB pc,PackageTB p where p.PackageID=pc.PackageID and pc.Is_Active=1");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
					  ...
					  ?>
                        <tr align="center">
                            <td><?php echo $b["PackageCategoryID"];?></td>
							<td><?php echo $b["Package_Name"];?></td>
							<td><?php echo $b["PackageCategoryName"];?></td>
							<td><?php echo $b["Description"];?></td>
							<td><a href="PackageCategoryInsert.php?id3=<?php echo $b["PackageCategoryID"];?>"><h3><i class="mdi mdi-border-color" style="color:blue;"></h3></i></a></td>
							<td><a href="../ui-features/Delete.php?id3=<?php echo $b["PackageCategoryID"];?>"><h3><i class="mdi mdi-delete-forever" style="color:red;"></h3></i></a></td>
					  <?php } ?>  
                        </tr>
                      </tbody>
                    </table>
