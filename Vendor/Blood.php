...
<!-- Mirrored from www.urbanui.com/serein/template/demo/vertical-default-light/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Apr 2019 07:03:01 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/VendorDetails/VendorDetails.php">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="Disease">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/Disease/AddDisease.php">ADD Disease</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Disease/DiseaseDetails.php">View Disease</a></li>
              </ul>
            </div>
          </li>
		  ...
		  <li class="nav-item">
            ...
            <div class="collapse" id="TestDisease">
              <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="pages/Test/TestDiseaseAdd.php">ADD TestDisease</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Test/TestDiseaseDisplay.php">View TestDisease</a></li>
              </ul>
            </div>
          </li>
		  ...
		  <li class="nav-item">
            ...
            <div class="collapse" id="Package">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/Package/PackageInsert.php">Insert Package</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Package/PackageDisplay.php">Select Package</a></li>
              </ul>
            </div>
          </li>
		  ...
		  <li class="nav-item">
            ...
            <div class="collapse" id="AgeWiseDisease">
              <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="pages/Age/AgeDiseaseAdd.php">ADD TestDisease</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Age/AgeDiseaseDisplay.php">View TestDisease</a></li>
              </ul>
            </div>
          </li>
            ...
            <div class="collapse" id="UserReport">
              <ul class="nav flex-column sub-menu">
               <!-- <li class="nav-item"> <a class="nav-link" href="pages/UserReport/UserReportAdd.php">Add UserReport</a></li>-->
                <li class="nav-item"> <a class="nav-link" href="pages/UserReport/UserReportDisplay.php">View UserReport</a></li>
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
               <div class="card-body">
                  <h2 class="card-title">TestDisease</h2>
                  <?php  //$rawQuery("select * from "); ?>
				 <form name="form1" class="forms-sample1" action="AgeDiseaseAdd.php" method="post" enctype="multipart/form-data"onsubmit="return(validate());">
				    <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-10 col-form-label">Blood Collection</label>
                          <div class="col-sm-9">
...
<!-- Mirrored from www.urbanui.com/serein/template/demo/vertical-default-light/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Apr 2019 07:03:39 GMT -->
</html>
<?php
   }
   else
   {
	   header("location:pages/samples/Vendorlogin.php");
   }
?>
